...
- Para cada una de las actividades propuestas, indique en el apartado respuesta de cada actividad tanto la solución como el proceso seguido para obtenerla.

- Enviarme por email a **calvo@us.es** la carpeta del proyecto con la solución en un **fichero comprimido con el siguiente nombre**: "FESTAD_P01_APELLIDOS_NOMBRE.zip", y el **asunto del email** empiece por: FESTAD_P01: APELLIDOS, NOMBRE.
